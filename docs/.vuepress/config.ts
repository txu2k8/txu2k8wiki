...
import { VdoingThemeConfig } from './plugins/vuepress-theme-vdoing/types'  // 使用npm主题包 vuepress-theme-vdoing/types
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/tools/',
        items: [
          { text: 'Fiddler', link: '/pages/59757d/' },
          { text: 'Jmeter', link: '/pages/a33b61/' },
          { text: 'Jmeter', link: '/pages/f9a175/' },
        ],
      },
      {
        text: '测试开发',
      ...
      },
      {
        ...
        link: '/special/',
        items: [
          { text: '安全测试', link: '/pages/253d16/' },
          { text: '兼容性测试', link: '/pages/290053/' },
          { text: '稳定性测试', link: '/pages/290053/' },
          { text: '混沌工程', link: '/pages/290053/' },
        ],
      },
      {
        text: '存储测试',
    ...
    repo: 'txu2k8/txu2k8wiki', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'Tao.Xu', // 必需
      link: 'https://github.com/txu2k8', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:tao.xu2008@outlook.com',
        },
        {
    ...
    footer: {
      ...
      copyrightInfo:
        'Tao Xu | <a href="https://github.com/txu2k8/txu2k8wiki/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/favicon.jpeg' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
